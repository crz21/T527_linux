...
/** 字符设备操作函数集，read */
static int bmi160_read(struct file *filp, char __user *buf, size_t len, loff_t *off) { return 0; }

/** 字符设备操作函数集，write */
static int bmi160_write(struct file *filp, const char __user *buf, size_t len, loff_t *off) { return 0; }
...
/** 驱动注销 */
static int __exit bmi160_driver_exit(void) { i2c_del_driver(&bmi160_driver); }
